...
This is my try at the obhect calisthenics kata *Back To The Checkout*.
Given four items with prices and discounts:

|Item Code (EAN)|Product   |Price|Discount |
|---------------|----------|-----|---------|
|A              |DVD       |12€  |3 for 28€|
|B              |CD Album  |8€   |-        |
...
The code should calculate the total sum:
    ...
    //and
    def actualTotal = checkout.total()
    
    //then
    assertEquals(expectedTotal, actualTotal)

To make things interesting, the following coding rules must be applied:
